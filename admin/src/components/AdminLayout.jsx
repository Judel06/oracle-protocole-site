...
const NAV_ITEMS = [
  ...
  { to: '/adhesions', label: 'Adhésions', icon: 'M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M11 3.13a4 4 0 010 7.75M21 21v-2a4 4 0 00-3-3.87M9 11a4 4 0 100-8 4 4 0 000 8z' },
